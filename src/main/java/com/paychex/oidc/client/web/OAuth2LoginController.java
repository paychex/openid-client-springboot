 ...
 */
package com.paychex.oidc.client.web;
...
/*
	...
	created on 2/2/20 8:28 AM
*/
@RestController
public class OAuth2LoginController {

	@GetMapping("/")
	public ResponseEntity<OidcUserInfo> getUserInfo(OAuth2AuthenticationToken currentUser) {
		return ResponseEntity.ok(((DefaultOidcUser) currentUser.getPrincipal()).getUserInfo());
	}
